...
async function fetchData() {
   ...
   loader.style.display = "block";
    ...
    try {
        ...
        if (!response.ok) {   alert("İstenilen Pokemon bulunamadı")
        ...
        const imgElement = document.getElementById("pokemonSprite") ;        imgElement.style.display = "none"; 

        imgElement.src = pokemonSprite;
        imgElement.style.display = "block";       loader.style.display = "none";
